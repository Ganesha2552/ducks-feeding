...
const Formview: React.FC = () => {
  ...
  const columns = [
    "Number of Ducks Fed",
    "Quantity of Food Fed (in lbs)",
    "Food Given",
    "Food Category",
    "Place of Feeding",
    "Time of Fed",
    "Daily insert of this record",
    "Delete Record",
  ];
  useEffect(() => {
    ...
    for (const key of Object.keys(records)) {
      ...
      let recordArr: any[] = [
        ...
        value.place_fed,
        value.time_fed,
        value.autoschedule_enable ? (
          <ToggleOnIcon className={classes.checkboxcolor} fontSize="large" />
        ) : (
        ...
        <DeleteForeverIcon
          fontSize="large"
          onClick={(e) => {
            dispatch(deleteFormRecord(value._id));
          }}
        />,
      ];
